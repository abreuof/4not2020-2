...
controller.listar = async (req, res) => {
    try {
    let dados = await Software.find() // Traz todos os cursos cadastrados
    res.send(dados)
    }
    catch(erro) {
        console.log(erro)
...
controller.obterUm = async (req, res) => {
    try {
        ...
        let obj = await Software.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let ret = await Software.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        let ret = await Software.findByIdAndDelete(id)
