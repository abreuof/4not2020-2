...
controller.listar = async (req, res) => {
    try {
    let dados = await Musica.find() // Traz todos os cursos cadastrados
    res.send(dados)
    }
    catch(erro) {
        console.log(erro)
...
controller.obterUm = async (req, res) => {
    try {
        ...
        let obj = await Musica.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let ret = await Musica.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        let ret = await Musica.findByIdAndDelete(id)
