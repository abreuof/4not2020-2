...
controller.listar = async (req, res) => {
    try {
    let dados = await Filme.find() // Traz todos os cursos cadastrados
    res.send(dados)
    }
    catch(erro) {
        console.log(erro)
...
controller.obterUm = async (req, res) => {
    try {
        ...
        let obj = await Filme.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let ret = await Filme.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        let ret = await Filme.findByIdAndDelete(id)
