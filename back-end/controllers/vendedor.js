...
controller.listar = async (req, res) => {
    try {
    let dados = await Vendedor.find() // Traz todos os cursos cadastrados
    res.send(dados)
    }
    catch(erro) {
        console.log(erro)
...
controller.obterUm = async (req, res) => {
    try {
        ...
        let obj = await Vendedor.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let ret = await Vendedor.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        let ret = await Vendedor.findByIdAndDelete(id)
