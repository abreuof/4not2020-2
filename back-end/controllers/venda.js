...
controller.listar = async (req, res) => {
    try {
    let dados = await Venda.find() // Traz todos os cursos cadastrados
        .populate('vendedor', 'nome')
        .populate('jogo', 'nome preco')
        .populate('filme', 'nome preco')
        .populate('musica', 'nome preco')
        .populate('software', 'nome preco')
...
controller.obterUm = async (req, res) => {
    try {
        ...
        let obj = await Venda.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let ret = await Venda.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        let ret = await Venda.findByIdAndDelete(id)
