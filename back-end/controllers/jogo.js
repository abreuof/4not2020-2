...
controller.listar = async (req, res) => {
    try {
    let dados = await Jogo.find() // Traz todos os cursos cadastrados
    res.send(dados)
    }
    catch(erro) {
        console.log(erro)
...
controller.obterUm = async (req, res) => {
    try {
        ...
        let obj = await Jogo.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let ret = await Jogo.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        let ret = await Jogo.findByIdAndDelete(id)
